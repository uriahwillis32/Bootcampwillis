...
public class MySQLShoppingCartDao extends MySqlDaoBase implements ShoppingCartDao
{
    ...
    public ShoppingCart getByUserId(int userId)
    {
        ...
        {
            System.out.println("Could not get products for userId: " + userId);
    ...
    public boolean addProductToCart(int userId, int productId)
    {
        ...
        try (Connection conn = getConnection())
        {
            try (PreparedStatement checkStmt = conn.prepareStatement(checkSql))
            {
                ...
                String sql = rs.next() ? updateSql : insertSql;
...
/*@Override
    public void addProductToCart(int userId, int productId)
    {
        ...
        {
            System.out.println("Could not add product " + productId + " to cart for userId: " + userId);
            throw new RuntimeException(e);
        }
    }*/
    ...
    public void updateProductQuantity(int userId, int productId, int quantity)
    {
        ...
        {
            System.out.println("Could not update quantity for productId: " + productId + " and userId: " + userId);
            throw new RuntimeException(e);
        }
    }
    ...
    public void removeAllCartItems(int userId)
    {
        ...
        {
            System.out.println("Could not clear cart for userId: " + userId);
            throw new RuntimeException(e);
        }
    }
}
